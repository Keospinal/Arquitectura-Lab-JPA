...
public class CompetitorService {
    ...
    public Response Login(CompetitorDTO competitor) throws JSONException {
        ...
        Query q = entityManager.createQuery("select u from Competitor u where u.address ='" + competitorTmp.getAddress() + "' and u.password ='" + competitorTmp.getPassword()+"'");
        ...
        if (!competitors.isEmpty()) {
            ...
            rta.put("NotAutorizedException","Invalid");
